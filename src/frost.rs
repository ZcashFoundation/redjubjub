...
#[derive(Clone)]
struct Commitment<S: SpendAuth>(<S::Point as CofactorCurve>::Affine);
...
/// final signature.
pub struct GroupCommitment<S: SpendAuth>(<S::Point as CofactorCurve>::Affine);
...
#[derive(Clone, Copy, Default)]
pub struct SignatureResponse<S: SpendAuth>(S::Scalar);
